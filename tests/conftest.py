...
from hwte.datasets.generator.base import synthesize_text_img
from hwte.io import reader
from hwte.utils import geometry
...
def mock_text_box_stream():
    url = "https://hwte-static.mindee.com/models?id=v0.5.1/word-crop.png&src=0"
...
def mock_artefact_image_stream():
    url = "https://github.com/mindee/hwte/releases/download/v0.8.1/artefact_dummy.jpg"
    return requests.get(url).content
...
def mock_svhn_dataset(tmpdir_factory, mock_image_stream):
    ...
    url = "https://github.com/mindee/hwte/releases/download/v0.9.0/digitStruct.mat"
