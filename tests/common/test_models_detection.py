...
from hwte.models.detection.differentiable_binarization.base import DBPostProcessor
from hwte.models.detection.fast.base import FASTPostProcessor
from hwte.models.detection.linknet.base import LinkNetPostProcessor
