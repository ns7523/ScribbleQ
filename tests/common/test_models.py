...
from hwte.models._utils import estimate_orientation, get_language, invert_data_structure
from hwte.utils import geometry


@pytest.fixture(scope="function")
def mock_image(tmpdir_factory):
    url = "https://hwte-static.mindee.com/models?id=v0.2.1/bitmap30.png&src=0"
