...
from hwte.models import kie_predictor
from hwte.utils.geometry import extract_crops, extract_rcrops
from hwte.utils.metrics import LocalizationConfusion, OCRMetric, TextMatch
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="hwte end-to-end evaluation", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
