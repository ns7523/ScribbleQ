...
version = hwte.__version__
release = hwte.__version__ + "-git"
...
html_logo = "_static/images/Logo-hwte-white.png"
html_favicon = "_static/images/favicon.ico"
html_title = "hwte documentation"
...
def add_ga_javascript(app, pagename, templatename, context, hwteee):
