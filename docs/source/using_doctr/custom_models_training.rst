...
If the pretrained models don't meet your specific needs, you have the option to train your own model using the hwte library.
For details on the training process and the necessary data and data format, refer to the following links:

- `detection <https://github.com/mindee/hwte/tree/main/references/detection#readme>`_
- `recognition <https://github.com/mindee/hwte/tree/main/references/recognition#readme>`_

If you’re looking for a lightweight yet efficient tool to annotate small amounts of data, especially tailored for hwte,
check out the `hwte Labeling Tool <https://github.com/text2knowledge/hwte-Labeler>`_.
...
This section shows how you can easily load a custom trained model in hwte.

.. code:: python3

    import torch
    from hwte.models import ocr_predictor, db_resnet50, crnn_vgg16_bn
...
.. code:: python3
    ...
    import torch
    from hwte.models import ocr_predictor, crnn_vgg16_bn
    from hwte.datasets import VOCABS
...
.. code:: python3
    ...
    import torch
    from hwte.models import kie_predictor, db_resnet50
...
.. code:: python3
    ...
    from hwte.models.preprocessor import PreProcessor
    from hwte.models import db_resnet50, crnn_vgg16_bn
...
You can train your own orientation classification model using the hwte library. For details on the training process and the necessary data and data format, refer to the following link:

- `orientation <https://github.com/mindee/hwte/blob/main/references/classification/README.md#usage-orientation-classification>`_
...
.. code:: python3
    ...
    from hwte.models import ocr_predictor, mobilenet_v3_small_page_orientation, mobilenet_v3_small_crop_orientation
    from hwte.models.classification.zoo import crop_orientation_predictor, page_orientation_predictor
