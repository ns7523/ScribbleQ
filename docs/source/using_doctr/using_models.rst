...
For a given task, hwte provides a Predictor, which is composed of 2 components:
...
* :py:meth:`linknet_resnet18 <hwte.models.detection.linknet_resnet18>`
* :py:meth:`linknet_resnet34 <hwte.models.detection.linknet_resnet34>`
* :py:meth:`linknet_resnet50 <hwte.models.detection.linknet_resnet50>`
* :py:meth:`db_resnet50 <hwte.models.detection.db_resnet50>`
* :py:meth:`db_mobilenet_v3_large <hwte.models.detection.db_mobilenet_v3_large>`
* :py:meth:`fast_tiny <hwte.models.detection.fast_tiny>`
* :py:meth:`fast_small <hwte.models.detection.fast_small>`
* :py:meth:`fast_base <hwte.models.detection.fast_base>`
...
:py:meth:`detection_predictor <hwte.models.detection.detection_predictor>` wraps your detection model to make it easily useable with your favorite deep learning framework seamlessly.

.. code:: python3

    import numpy as np
    from hwte.models import detection_predictor
...
* :py:meth:`crnn_vgg16_bn <hwte.models.recognition.crnn_vgg16_bn>`
* :py:meth:`crnn_mobilenet_v3_small <hwte.models.recognition.crnn_mobilenet_v3_small>`
* :py:meth:`crnn_mobilenet_v3_large <hwte.models.recognition.crnn_mobilenet_v3_large>`
* :py:meth:`sar_resnet31 <hwte.models.recognition.sar_resnet31>`
* :py:meth:`master <hwte.models.recognition.master>`
* :py:meth:`vitstr_small <hwte.models.recognition.vitstr_small>`
* :py:meth:`vitstr_base <hwte.models.recognition.vitstr_base>`
* :py:meth:`parseq <hwte.models.recognition.parseq>`
* :py:meth:`viptr_tiny <hwte.models.recognition.viptr_tiny>`
...
.. code:: python3
    ...
    from hwte.models import recognition_predictor
...
^^^^^^^^^^^^^^^^^^^^^^
:py:meth:`recognition_predictor <hwte.models.recognition.recognition_predictor>` wraps your recognition model to make it easily useable with your favorite deep learning framework seamlessly.
...
You can use any combination of detection and recognition models supported by hwte.
...
^^^^^^^^^^^^^^^^^^^^
Those architectures involve one stage of text detection, and one stage of text recognition. The text detection will be used to produces cropped images that will be passed into the text recognition block. Everything is wrapped up with :py:meth:`ocr_predictor <hwte.models.ocr_predictor>`.
...
.. code-block:: xml
  ...
  <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
      <title>hwte - hOCR</title>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <meta name="ocr-system" content="hwte 0.11.0" />
