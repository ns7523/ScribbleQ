...
.. currentmodule:: hwte.models.utils
...
.. code:: python3
    ...
    import torch
    from hwte.models import vitstr_small
...
It is simple and easy-to-use (with the same interface you know already from hwte), that allows you to perform inference with your exported model.
