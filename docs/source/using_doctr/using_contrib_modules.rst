...
.. code:: bash
    ...
    pip install python-hwte[contrib]
    # Or
    pip install onnxruntime  # pip install onnxruntime-gpu

Here are all contribution modules that are available through hwte:
...
.. code:: python3
    ...
    from hwte.contrib.artefacts import ArtefactDetector
...
.. code:: python3
    ...
    from hwte.contrib import ArtefactDetector
