...
This section highlights notable tools developed by the hwte community.


hwte-Labeler
-------------

:Link: https://github.com/text2knowledge/hwte-Labeler

**Overview**

``hwte-Labeler`` is a dedicated annotation tool tailored for creating and editing OCR datasets to train and fine-tune hwte models. It offers a user-friendly graphical interface, featuring polygon-based text labeling, automatic annotation suggestions via OnnxTR, and convenient label export capabilities.
...
* Flexible Access: CLI launch with ``hwte-labeler`` command and full programmatic Python API integration
...
``OnnxTR`` provides an ONNX-based backend for hwte models, enabling fast, cross-platform inference using ONNX Runtime. It's a core refactored library that enhances the performance and flexibility of OCR tasks without relying on heavy frameworks like PyTorch or TensorFlow.
...
* Familiar API: One-line inference via ``onnxtr.models.ocr_predictor`` (similar to hwte)
...
Have you built something amazing on top of hwte ?

We'd love to showcase your work! Whether it's a useful plugin, dataset preparation tool, or any other hwte-based project, the community would benefit from learning about it.

**How to Contribute**

To contribute your tool to the hwte community, please follow these steps:
...
.. tip::
   Include a clear tool description and highlight what makes your tool unique or particularly useful to the hwte community.
