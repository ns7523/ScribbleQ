...
This section contains some cool resources created by the hwte community.
...
* |:video_camera:| Mindee hwte - Probably the Best Open-Source OCR:
...
* |:book:| Extract Text from images in Python with hwte:
    `Article <https://medium.com/@netrajpatil12mati/extract-text-from-images-in-python-with-hwte-455970878507>`_ created by: `Netraj Patil`.
...
* |:book:| Real-time information extraction from documents with hwte:
    `Article <https://analyticsindiamag.com/ai-mysteries/real-time-information-extraction-from-documents-with-hwte/>`_ created by: `Yugesh Verma`.
