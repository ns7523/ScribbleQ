...
function addGithubButton() {
    const div = `
        <div class="github-repo">
            <a
                class="github-button"
                href="https://github.com/mindee/hwte" data-size="large" data-show-count="true" aria-label="Star mindee/hwte on GitHub">
                Star
            </a>
        </div>
    `;
...
function addVersionControl() {
    ...
    for (const [key, value] of Object.entries(versionMapping)) {
        let baseUrlIndex = (version == "hwte") ? versionIndex + 1: versionIndex;
    ...
    let label = (version == "hwte") ? stableVersion : version
