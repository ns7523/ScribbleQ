********************************
hwte: Document Text Recognition
********************************

State-of-the-art Optical Character Recognition made seamless & accessible to anyone, powered by PyTorch

.. image:: https://github.com/mindee/hwte/releases/download/v0.2.0/ocr.png
        :align: center


hwte provides an easy and powerful way to extract valuable information from your documents:
...
.. toctree::
   ...
   using_hwte/using_models
   using_hwte/using_datasets
   using_hwte/using_contrib_modules
   using_hwte/sharing_models
   using_hwte/using_model_export
   using_hwte/custom_models_training
   using_hwte/running_on_aws
