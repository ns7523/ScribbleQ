...
from hwte import datasets
from hwte import transforms as T
from hwte.datasets import VOCABS, RecognitionDataset, WordGenerator
from hwte.models import login_to_hub, push_to_hf_hub, recognition
from hwte.utils.metrics import TextMatch
...
def main(args):
    ...
    if rank == 0 and args.clearml:
        ...
        task = Task.init(project_name="hwte/text-recognition", task_name=exp_name, reuse_last_task_id=False)
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="hwte training script for text recognition (PyTorch)",
