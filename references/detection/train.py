...
from hwte.models import detection, login_to_hub, push_to_hf_hub
from hwte.utils.metrics import LocalizationConfusion
...
def main(args):
    ...
    if args.clearml:
        ...
        task = Task.init(project_name="hwte/text-detection", task_name=exp_name, reuse_last_task_id=False)
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="hwte training script for text detection (PyTorch)",
