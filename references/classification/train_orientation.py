...
from hwte.datasets import OrientationDataset
...
def main(args):
    ...
    if args.clearml:
        ...
        task = Task.init(project_name="hwte/orientation-classification", task_name=exp_name, reuse_last_task_id=False)
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="hwte training script for orientation classification (PyTorch)",
