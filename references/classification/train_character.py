...
from hwte.datasets import VOCABS, CharacterGenerator
from hwte.models import classification, login_to_hub, push_to_hf_hub
from hwte.models.utils import export_model_to_onnx
...
def main(args):
    ...
    if args.clearml:
        ...
        task = Task.init(project_name="hwte/character-classification", task_name=exp_name, reuse_last_task_id=False)
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="hwte training script for character classification (PyTorch)",
