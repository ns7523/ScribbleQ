...
from hwte.utils.common_types import BoundingBox
from hwte.utils.geometry import resolve_enclosing_bbox, resolve_enclosing_rbbox
from hwte.utils.reconstitution import synthesize_kie_page, synthesize_page
from hwte.utils.repr import NestedObject

try:  # optional dependency for visualization
    from hwte.utils.visualization import visualize_kie_page, visualize_page
...
class Page(Element):
    ...
    def export_as_xml(self, file_title: str = "hwte - XML export (hOCR)") -> tuple[bytes, ET.ElementTree]:
        ...
        SubElement(
            head,
            "meta",
            attrib={"name": "ocr-system", "content": f"python-hwte {hwte.__version__}"},  # type: ignore[attr-defined]
        )
        SubElement(
            head,
            "meta",
