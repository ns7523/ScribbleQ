...
class CORD(VisionDataset):
    ...
    .. image:: https://hwte-static.mindee.com/models?id=v0.5.0/cord-grid.png&src=0
        :align: center
    ...
    TRAIN = (
        "https://hwte-static.mindee.com/models?id=v0.1.1/cord_train.zip&src=0",
        "45f9dc77f126490f3e52d7cb4f70ef3c57e649ea86d19d862a2757c9c455d7f8",
        "cord_train.zip",
    )

    TEST = (
        "https://hwte-static.mindee.com/models?id=v0.1.1/cord_test.zip&src=0",
