...
class DocArtefacts(VisionDataset):
    ...
    .. image:: https://hwte-static.mindee.com/models?id=v0.5.0/artefacts-grid.png&src=0
        :align: center
    ...
    URL = "https://hwte-static.mindee.com/models?id=v0.4.0/artefact_detection-13fab8ce.zip&src=0"
