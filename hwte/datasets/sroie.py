...
class SROIE(VisionDataset):
    ...
    .. image:: https://hwte-static.mindee.com/models?id=v0.5.0/sroie-grid.png&src=0
        :align: center

    >>> from hwte.datasets import SROIE
    ...
    TRAIN = (
        "https://hwte-static.mindee.com/models?id=v0.1.1/sroie2019_train_task1.zip&src=0",
        "d4fa9e60abb03500d83299c845b9c87fd9c9430d1aeac96b83c5d0bb0ab27f6f",
        "sroie2019_train_task1.zip",
    )
    TEST = (
        "https://hwte-static.mindee.com/models?id=v0.1.1/sroie2019_test.zip&src=0",
