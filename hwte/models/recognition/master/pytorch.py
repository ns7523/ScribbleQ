...
from hwte.models.classification import magc_resnet31
from hwte.models.modules.transformer import Decoder, PositionalEncoding
...
def master(pretrained: bool = False, **kwargs: Any) -> MASTER:
    ...
    >>> import torch
    >>> from hwte.models import master
