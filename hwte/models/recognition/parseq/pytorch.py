...
from hwte.models.modules.transformer import MultiHeadAttention, PositionwiseFeedForward
...
class PARSeq(_PARSeq, nn.Module):
    ...
    def from_pretrained(self, path_or_url: str, **kwargs: Any) -> None:
        ...
        """
        # NOTE: This is required to make the model backward compatible with already trained models hwte version <0.11.1
        # ref.: https://github.com/mindee/hwte/issues/1911
...
def parseq(pretrained: bool = False, **kwargs: Any) -> PARSeq:
    ...
    >>> import torch
    >>> from hwte.models import parseq
