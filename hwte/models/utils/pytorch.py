...
def load_pretrained_params(
    ...
    **kwargs: Any,
    ...
    >>> from hwte.models import load_pretrained_params
    ...
    Args:
        ...
        **kwargs: additional arguments to be passed to `hwte.utils.data.download_from_url`
    """
...
def conv_sequence_pt(
    ...
    **kwargs: Any,
    ...
    >>> from hwte.models import conv_sequence
...
def set_device_and_dtype(
    ...
    >>> import torch
    >>> from torch import nn
    >>> from hwte.models.utils import set_device_and_dtype
...
def export_model_to_onnx(model: nn.Module, model_name: str, dummy_input: torch.Tensor, **kwargs: Any) -> str:
    ...
    >>> import torch
    >>> from hwte.models.classification import resnet18
