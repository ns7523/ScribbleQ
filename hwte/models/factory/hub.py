...
def push_to_hf_hub(model: Any, model_name: str, task: str, **kwargs) -> None:  # pragma: no cover
    ...
    >>> from hwte.models import login_to_hub, push_to_hf_hub
    >>> from hwte.models.recognition import crnn_mobilenet_v3_small
    >>> login_to_hub()
    ...
    <p align="center">
    <img src="https://hwte-static.mindee.com/models?id=v0.3.1/Logo_hwte.gif&src=0" width="60%">
    </p>
...
def from_hub(repo_id: str, **kwargs: Any):
    ...
    >>> from hwte.models import from_hub
