...
class SampleCompose(NestedObject):
    ...
    .. code:: python
        ...
        >>> import numpy as np
        >>> import torch
        >>> from hwte.transforms import SampleCompose, ImageTransform, ColorInversion, RandomRotate
...
class ImageTransform(NestedObject):
    ...
    .. code:: python
        ...
        >>> import torch
        >>> from hwte.transforms import ImageTransform, ColorInversion
...
class ColorInversion(NestedObject):
    ...
    .. code:: python
        ...
        >>> import torch
        >>> from hwte.transforms import ColorInversion
...
class OneOf(NestedObject):
    ...
    .. code:: python
        ...
        >>> import torch
        >>> from hwte.transforms import OneOf
...
class RandomApply(NestedObject):
    ...
    .. code:: python
        ...
        >>> import torch
        >>> from hwte.transforms import RandomApply
...
class RandomRotate(NestedObject):
    ...
    .. image:: https://hwte-static.mindee.com/models?id=v0.4.0/rotation_illustration.png&src=0
        :align: center
