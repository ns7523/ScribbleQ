...
class Resize(T.Resize):
    ...
    >>> import torch
    >>> from hwte.transforms import Resize
...
class GaussianNoise(torch.nn.Module):
    ...
    >>> import torch
    >>> from hwte.transforms import GaussianNoise
...
class GaussianBlur(torch.nn.Module):
    ...
    >>> import torch
    >>> from hwte.transforms import GaussianBlur
...
class RandomShadow(torch.nn.Module):
    ...
    >>> import torch
    >>> from hwte.transforms import RandomShadow
...
class RandomResize(torch.nn.Module):
    ...
    >>> import torch
    >>> from hwte.transforms import RandomResize
